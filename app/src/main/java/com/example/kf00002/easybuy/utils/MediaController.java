package com.example.kf00002.easybuy.utils;
...
public class MediaController extends android.widget.MediaController {
	...
	private Button m_video_back;
	
	private TextView m_video_title;

	public MediaController(Activity activity,String name) {
		super(activity);
		mActivity = activity;
		stringName = name;
	...
	public void setAnchorView(View view) {
		...
		m_video_back = (Button) mView.findViewById(R.id.m_video_back);
//		m_video_title= (TextView) mView.findViewById(R.id.m_video_title);
//		
//		
//		m_video_title.setText(stringName);
//		Log.e("===============", "stringName="+stringName);
		
		try {
			
			m_video_back.setOnClickListener(new OnClickListener() {
